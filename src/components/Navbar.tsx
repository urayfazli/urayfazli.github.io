        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3 min-w-0">
            <motion.div 
              ...
              className="w-10 h-10 rounded-lg bg-[#2B6CB0] hover:bg-[#2C5282] flex items-center justify-center text-white shadow-xs cursor-pointer shrink-0 transition-colors"
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                ...
                <span 
                  id="tag-web-badge" 
                  className="hidden sm:inline-flex items-center px-2 py-0.5 rounded text-[11px] font-semibold bg-[#EBF8FF] text-[#2B6CB0] border border-[#BEE3F8]"
                >
                  NodeOps
                </span>
              </div>
